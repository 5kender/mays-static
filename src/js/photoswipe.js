  ...
  'DOMContentLoaded', () => {
    const initPhotoSwipeFromDOM = (gallerySelector) => {
      ...
      var parseThumbnailElements = function(el) {
        var thumbElements = Array.prototype.slice.call(document.querySelectorAll('.gallery-item')),
      ...
      var onThumbnailsClick = function(e) {
        ...
        var clickedGallery = document.querySelectorAll('.my-gallery')[0],
          childNodes = Array.prototype.slice.call(document.querySelectorAll('.gallery-item')),
